...
function toggleFields() {
	...
	//LOGIC FOR events
	if (($("#eventname").val()=='rangoli') || ($("#eventname").val()=='dance_duet') || 
	($("#eventname").val()=='singing_duet')) {
        $("#div_1").slideDown();
        $("#div_2").slideDown();
        $("#div_3").slideUp();
        $("#div_4").slideUp();
		...
		else if(($("#eventname").val()=='mini_militia'))
	   	{
			$("#member_2").prop('required',true);
    ...
    else if (($("#eventname").val()=='main_bhi_filmy_hoon') || ($("#eventname").val()=='mini_militia') 
		|| ($("#eventname").val()=='crab_soccer')){
        $("#div_1").slideDown();
        $("#div_2").slideDown();
        $("#div_3").slideDown();
        $("#div_4").slideDown();
		...
		else if(($("#eventname").val()=='crab_soccer'))
	   	{
			$("#member_2").prop('required',true);
			$("#member_3").prop('required',true);
			$("#member_3").prop('required',true);
	   ...
	   else if(($("#eventname").val()=='ulta_fulta_film_jagat') || ($("#eventname").val() == 'singing_group'))
	   {
        ...
        if(($("#eventname").val()=='dance_group'))
	   	...
	   	else if(($("#eventname").val()=='nukkad_natak'))
	   	{
		 	...
		 	$("#member_5").prop('required',true);
		 	$("#member_6").prop('required',true);
		 	$("#member_7").prop('required',true);
		 	$("#member_8").prop('required',true);
		 	$("#member_9").prop('required',false);
		 	$("#member_10").prop('required',false);
		 	$("#member_11").prop('required',false);
		 	$("#member_12").prop('required',false);
